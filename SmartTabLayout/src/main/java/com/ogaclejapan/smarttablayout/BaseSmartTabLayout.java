...
public abstract class BaseSmartTabLayout extends HorizontalScrollView {
    ...
    protected static final boolean DEFAULT_DISTRIBUTE_EVENLY = false;
    protected static final int TITLE_OFFSET_DIPS = 24;
    protected static final int TITLE_OFFSET_AUTO_CENTER = -1;
    protected static final int TAB_VIEW_PADDING_DIPS = 16;
    protected static final boolean TAB_VIEW_TEXT_ALL_CAPS = true;
    protected static final int TAB_VIEW_TEXT_SIZE_SP = 12;
    protected static final int TAB_VIEW_TEXT_COLOR = 0xFC000000;
    protected static final int TAB_VIEW_TEXT_MIN_WIDTH = 0;
    protected static final boolean TAB_CLICKABLE = true;

    protected final SmartTabStrip tabStrip;
    protected int titleOffset;
    protected int tabViewBackgroundResId;
    ...
    public BaseSmartTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseSmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundResId =
                a.getResourceId(R.styleable.stl_SmartTabLayout_stl_defaultTabBackground,
                        tabBackgroundResId);
        textAllCaps =
        ...
        textMinWidth =
                a.getDimensionPixelSize(R.styleable.stl_SmartTabLayout_stl_defaultTabTextMinWidth,
                        textMinWidth);
        customTabLayoutId =
                a.getResourceId(R.styleable.stl_SmartTabLayout_stl_customTabTextLayoutId,
                        customTabLayoutId);
        customTabTextViewId =
                a.getResourceId(R.styleable.stl_SmartTabLayout_stl_customTabTextViewId,
                        customTabTextViewId);
        distributeEvenly =
        ...
        titleOffset =
                a.getLayoutDimension(R.styleable.stl_SmartTabLayout_stl_titleOffset, titleOffset);
        a.recycle();
    ...
    protected void scrollToTab(int tabIndex, float positionOffset) {
        ...
        if (isLayoutRtl) {
            x += start + startMargin - extraOffset - getWidth() + Utils.getPaddingHorizontally(
                    this);
        } else {
     ...
     * {@link #setCustomTabView(BaseSmartTabLayout.TabProvider)}
     */
    ...
    private static class SimpleTabProvider implements TabProvider {
        ...
        @Override public View createTabView(ViewGroup container, int position,
                @Nullable CharSequence pageTitle) {
            View tabView = null;
